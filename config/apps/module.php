    ...
    'module' => [
        ...
        [
            ...
            'route' => [
                ...
                'warehouse.edit_import',
                'warehouse.create_export',
                'warehouse.edit_export',
            ...
            'subModule' => [
                [
                    ...
                    'route_action' => ['warehouse.create_import', 'warehouse.edit_import', 'warehouse.trash'],
                    'icon' => 'fa fa-download',
                    'user_role' => [0, 1],
                ],
                [
                    ...
                    'route_action' => ['warehouse.create_export', 'warehouse.edit_export', 'warehouse.trash_export'],
                    'icon' => 'fa fa-upload',
                    'user_role' => [0, 1],
                ],
                [
