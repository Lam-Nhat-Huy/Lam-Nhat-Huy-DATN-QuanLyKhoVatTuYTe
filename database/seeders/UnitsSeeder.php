    ...
    public function run()
    {
        DB::table('units')->insert([
            ...
            [
                'code' => 'UNIT009',
                'name' => 'Gói',
                'description' => 'Đơn vị đo số lượng các thiết bị, vật tư đóng gói',
                'created_by' => 'U001',
                'created_at' => now(),
                'updated_at' => null,
                'deleted_at' => null,
            ...
            [
                'code' => 'UNIT010',
                'name' => 'Cuộn',
                'description' => 'Đơn vị đo các vật tư cuộn như băng gạc, băng keo',
                'created_by' => 'UNIT010',
                'created_at' => now(),
                'updated_at' => null,
                'deleted_at' => null,
            ...
            [
                'code' => 'UNIT012',
                'name' => 'Túi',
                'description' => 'Đơn vị đo số lượng túi vật tư y tế',
                'created_by' => 'UNIT012',
                'created_at' => now(),
                'updated_at' => null,
                'deleted_at' => null,
