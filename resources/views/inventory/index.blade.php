            ...
            <div style="display: flex; justify-content: space-evenly; align-items: center;">
                @php
                    ...
                    if ($totalQuantity < 1) {
                        ...
                        $icon =
                            '<i class="fa-solid fa-exclamation-triangle text-right" style="color:red; font-size: 13px;" data-bs-toggle="tooltip" data-bs-placement="top" title="Hết hàng"></i>';
                        $bgColor = 'background-color: rgba(255, 0, 0, 0.1);';
                    } elseif ($totalQuantity <= 10) {
                        $quantityColor = 'color: orange; font-weight: bold;';
                        $icon =
                            '<i class="fa-solid fa-exclamation-triangle text-right" style="color:orange; font-size: 13px;" data-bs-toggle="tooltip" data-bs-placement="top" title="Cảnh báo: Số lượng thấp"></i>';
                        $bgColor = 'background-color: rgba(255, 165, 0, 0.1);';
                    } else {
                        $quantityColor = 'color: #28a745; font-weight: bold;';
                        $icon =
                            '<i class="fa-solid fa-check text-right" style="color:#28a745; font-size:13px;" data-bs-toggle="tooltip" data-bs-placement="top" title="Còn hàng"></i>';
                            ...
                            <tbody id="modalItemsTableBody">
                                @forelse ($inventories[$equipment->code]['inventories'] as $index => $inventory)
                                    ...
                                    <tr class="text-center"
                                        ...
                                        <td>
                                            {{ $inventory->production_date ? \Carbon\Carbon::parse($inventory->production_date)->format('d-m-Y') : 'Không có ' }}
                                        </td>
                                        <td>
                                            {{ $inventory->production_expiry_date ? \Carbon\Carbon::parse($inventory->production_expiry_date)->format('d-m-Y') : 'Không có ' }}
                                        </td>
