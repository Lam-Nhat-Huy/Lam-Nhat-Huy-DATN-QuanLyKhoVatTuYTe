    ...
    <div class="card mb-5 pb-5 mb-xl-8">
        <div class="card-header border-0 pt-5">
            ...
            <div class="card-toolbar">
                <a href="{{ route('warehouse.export') }}" class="btn btn-sm btn-dark" style="font-size: 12px;"><i
                    ...
                    {{-- <div class="col-12">
                        <div class="input-group mb-3">
                            ...
                            <button type="button" class="btn btn-sm btn-success" data-bs-toggle="modal"
                                data-bs-target="#exportExcelModal" style="font-size: 12px;">Nhập Excel</button>
                        </div>
                    </div> --}}
                        ...
                        <div class="mt-3">
                            <div class="row mb-3">
                                <div class="col-12 mb-2">
                                    ...
                                    <select class="form-select form-select-sm form-select-solid border border-success"
