                        ...
                        <tbody>
                            @forelse ($receipts as $item)
                                <tr class="hover-table pointer">
                                    ...
                                    <td class="custom-w">
                                        @if ($item->receipt_type === 'Nhập Từ Nhà Cung Cấp')
                                            {{ $item->receipt_type }} <i class="fa fa-truck"></i>
                                        @elseif ($item->receipt_type === 'Nhập cân bằng kho')
                                            {{ $item->receipt_type }} <i class="fa fa-scale-balanced"></i>
                                        @endif
                                    </td>
                                    <td>
                                                ...
                                                <div class="card-header d-flex justify-content-between align-items-center p-3 pb-0"
                                                    ...
                                                    <div class="card-toolbar">
                                                        ...
                                                        @elseif ($item->status == 2)
                                                            ...
                                                            <div class="modal fade" id="detail_reason_{{ $item->code }}"
                                                                tabindex="-1" aria-labelledby="checkModalLabel"
                                                                aria-hidden="true">
                                                        ...
                                                        @elseif ($item->status == 1)
                                                            @if (session('isAdmin') == 1 && $item->browse_by == session('user_code'))
                                                                <button type="button" style="font-size: 12px !important"
                                                                    ...
                                                                    {{ str_contains($item->code, 'PN-KK') ? 'disabled' : '' }}>
                                                                    <i class="fa fa-trash"
        ...
        <div class="modal fade" id="noBrowse_{{ $item->code }}" tabindex="-1" aria-labelledby="checkModalLabel"
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content border-0 shadow">
                    ...
                    <form action="{{ route('warehouse.import') }}" id="form_refuse" method="POST">
                        @csrf
