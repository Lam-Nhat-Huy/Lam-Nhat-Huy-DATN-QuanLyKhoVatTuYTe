    ...
    <div class="card mb-5 pb-5 mb-xl-8">
        <div class="card-header border-0 pt-5">
            ...
            <div class="card-toolbar">
                <a href="{{ route('material_request.export_trash') }}" class="btn btn-sm btn-danger me-2">
                    <span class="align-items-center d-flex">
                        <i class="fa fa-trash me-1"></i>
                        Thùng Rác
                    </span>
                </a>
                <a href="{{ route('material_request.create_export') }}" class="btn btn-success btn-sm">
                                ...
                                <div class="card-body py-3 text-end">
                                    <div class="button-group">
                                        @if (1 == 1)
                                            ...
                                            <!-- Nút Sửa đơn -->
                                            <a href="{{ route('material_request.update_export') }}"
