...
<div class="card-body py-1 me-6">
    <form action="{{ route('equipments.index') }}" method="GET" class="row align-items-center">
        <div class="col-4">
            <select name="equipment_type_code" class="mt-2 mb-2 form-select form-select-sm form-select-solid setupSelect2">
        ...
        <div class="col-4">
            <select name="unit_code" class="mt-2 mb-2 form-select form-select-sm form-select-solid setupSelect2">
            ...
            @foreach ($AllMaterial as $item)
                <div class="col-xl-12 mb-2">
                    ...
                    <div class="card mb-1 card-body p-2 pointer" data-bs-toggle="collapse" 
                         data-bs-target="#collapse{{ $item->code }}" aria-expanded="false" aria-controls="collapse{{ $item->code }}">
                        <div class="row align-items-center g-1">
                            <div class="col-auto">
                                <a href="#">
                                    {{-- Hiển thị hình ảnh với đường dẫn đầy đủ --}}
                                    <img src="{{ asset('images/equipments/' . $item->image) }}" class="width-90 rounded-3 mr-2"
                                    ...
                                    <div class="row align-items-center g-1">
                                        <div class="col">
                                            ...
                                            <p class="mb-1 small text-muted">
                                                Hạn sử dụng: {{ $item->expiry_date ? \Carbon\Carbon::parse($item->expiry_date)->format('d/m/Y') : 'Không Có' }} - {{ $item->time_remaining }}
                                            </p>
                                        </div>
                                        <div class="col-auto">
                        ...
                        <div class="card card-body p-2" style="border: 1px solid #dcdcdc; background-color: #f8f9fa;">
                            <div class="row gy-3">
                                <div class="col-md-4">
                                    ...
                                    <img src="{{ asset('images/equipments/' . $item->image) }}" alt="" width="100%"
                                    ...
                                    <div class="card card-body border-0">
                                                ...
                                                <table class="table table-borderless">
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="text-gray-800">trống</td>
                                                        </tr>
                                                        <tr>
                                        ...
                                        <div class="text-end mt-4">
                                            <div class="button-group">
                                                <!-- Nút Cập nhật -->
                                                <a href="{{ route('equipments.update_equipments', $item->code) }}" class="btn btn-sm btn-success me-2">
                                                    <i class="fa fa-edit"></i>Cập Nhật
                                                </a>
                                                <button class="btn btn-sm btn-danger me-2" data-bs-toggle="modal" data-bs-target="#deleteConfirm{{ $item->code }}">
    ...
    <!-- Modal Xác Nhận Xóa -->
    <div class="modal fade" id="deleteConfirm{{ $item->code }}" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="deleteConfirmLabel" aria-hidden="true">
