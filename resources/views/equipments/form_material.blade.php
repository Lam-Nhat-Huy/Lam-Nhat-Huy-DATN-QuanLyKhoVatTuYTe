                ...
                <div class="me-n7 pe-7">
                    <div class="row align-items-center mb-8">
                        <div class="col-12 mb-5">
                            ...
                            <img id="preview-image" src="{{ isset($currentEquipment->image) ? asset('images/equipments/' . $currentEquipment->image) : '' }}" 
                                 width="200" 
                        ...
                        <div class="col-6 fv-row mb-5">
                            ...
                            <input type="file" class="form-control form-control-sm form-control-solid border border-success" name="material_image" accept="image/*">
                        </div>
                        <div class="col-6 fv-row mb-5">
                        ...
                        <div class="col-6 fv-row mb-5">
                            ...
                            <div class="d-flex align-items-center">
                                <select name="equipment_type_code" class="form-select form-select-sm form-select-solid setupSelect2">
                                ...
                                <span class="ms-4 pointer" data-bs-toggle="modal" data-bs-target="#add_modal_nvt_" title="Thêm Nhóm Vật Tư">
                        ...
                        <div class="col-6 fv-row mb-5">
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <span class="ms-4 pointer" data-bs-toggle="modal" data-bs-target="#add_modal_dvt_" title="Thêm Đơn Vị Tính">
                                    <i class="fa fa-plus text-white py-2 px-2 bg-success rounded-circle"></i>
                                </span>
                            </div>
                        </div>
                        <div class="col-6 fv-row mb-5">
                            ...
                            <input type="number" class="form-control form-control-sm form-control-solid border border-success" 
                                   name="price" 
                                   value="{{ old('price', isset($currentEquipment) ? $currentEquipment->price : 0) }}">
                        </div>
                        <div class="col-6 fv-row mb-5">
                            <label class="fs-5 fw-bold mb-3">Ngày Hết Hạn (Nếu Có)</label>
                            <input type="date" class="form-control form-control-sm form-control-solid border border-success" 
                                   name="expiry_date" 
                        ...
                        <div class="col-6 fv-row mb-5">
                            ...
                            <div class="d-flex align-items-center">
                                <select name="supplier_code" class="form-select form-select-sm form-select-solid setupSelect2">
                                ...
                                <span class="ms-4 pointer" data-bs-toggle="modal" data-bs-target="#add_modal_ncc_" title="Thêm Nhà Cung Cấp">
                                    <i class="fa fa-plus text-white py-2 px-2 bg-success rounded-circle"></i>
                                </span>
                            </div>
                        </div>
                        <div class="col-6 fv-row mb-5">
                            ...
                            <select name="country" class="form-select form-select-sm form-select-solid setupSelect2">
                                <option value="Vietnam" {{ old('country', isset($currentEquipment) ? $currentEquipment->country : '') == 'Vietnam' ? 'selected' : '' }}>Việt Nam</option>
                                <option value="United States" {{ old('country', isset($currentEquipment) ? $currentEquipment->country : '') == 'United States' ? 'selected' : '' }}>Hoa Kỳ</option>
                                <option value="China" {{ old('country', isset($currentEquipment) ? $currentEquipment->country : '') == 'China' ? 'selected' : '' }}>Trung Quốc</option>
                            </select>
                        </div>
                        
                        <div class="col-12 fv-row mb-5">
                            <label class="required fs-5 fw-bold mb-3">Mô Tả</label>
                            <textarea name="description" cols="30" rows="10" class="form-control form-control-sm form-control-solid border border-success"
