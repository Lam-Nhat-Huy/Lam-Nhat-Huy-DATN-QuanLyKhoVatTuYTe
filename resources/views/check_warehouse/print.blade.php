                ...
                <div class="card-body p-3 pt-0">
                    <div class="row py-5" style="padding-top: 0px !important">
                        ...
                        <div class="col-md-4 pb-0">
                            <table class="table table-dark gy-1">
                                <tbody>
                                    <tr>
                                        <td class="text-dark" style="width: 150px;">
                                            <strong>Mã kiểm
                                                kho</strong>
                                        </td>
                                    ...
                                    <tr>
                                        <td class="text-dark"><strong>Thời
                                                gian</strong></td>
                                        <td class="text-gray-800">
                                    ...
                                    <tr>
                                        <td class="text-dark"><strong>Ngày
                                                cân bằng</strong></td>
                                        @if ($item['check_date'])
                                            <td class="text-gray-800">
                    ...
                    <div class="col-md-12">
                        <div class="table-responsive">
                            <table class="table border border-dark align-middle">
                                <thead class="bg-success border border-dark text-center">
                                    <tr>
                                        <th style="width: 10%;" class="text-dark ps-3">Mã
                                            thiết bị</th>
                                        <th style="width: 35%;" class="text-dark">Tên
                                            thiết bị</th>
                                        <th style="width: 10%;" class="text-dark">Số
                                            lô</th>
                                        <th style="width: 10%;" class="text-dark">TK
                                        </th>
                                        <th style="width: 10%;" class="text-dark">
                                            SLTT</th>
                                        <th style="width: 10%;" class="text-dark">SL
                                            lệch</th>
                                        <th style="width: 25%;" class="text-dark pe-3">Ghi
                                            chú</th>
                                    </tr>
                                </thead>
                                <tbody>
                                        ...
                                        @if ($detail['check_round'] == 2)
                                            <tr class="border border-dark">
                                                ...
                                                <td data-bs-toggle="tooltip" data-bs-placement="top"
                                                    title="{{ $detail->equipment->name }}" style="">
