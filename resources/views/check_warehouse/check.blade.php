                ...
                <tbody>
                    @forelse ($inventoryChecks as $item)
                                        ...
                                        <tr class="text-center hover-table pointer">
                                            ...
                                            <td data-bs-toggle="collapse" data-bs-target="#collapse_{{ $item->code }}" aria-expanded="false"
                                        ...
                                        <tr>
                                            <td class="p-0" colspan="12" style="background-color: #fafafa; padding-top: 0 !important;">
                                                                    ...
                                                                    <table class="table table-striped table-sm table-hover">
                                                                        ...
                                                                        <tbody>
                                                                                    ...
                                                                                    <td colspan="12" class="text-center">
                                                                                        <div class="alert alert-secondary d-flex flex-column align-items-center justify-content-center p-4"
                                                                                            ...
                                                                                            <div class="text-center">
                                                                                                <h5 style=font-weight: 600; color: #495057;">
                                                                            ...
                                                                            @else
                                                                                                                        @foreach ($item['details'] as $detail)
                                                                                                                                                                    @if ($detail['check_round'] == 2)
                                                                                                                                                                                                                <tr class=" hover-table pointer" data-bs-toggle="collapse"
