...
class UpdateUserRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'email' => 'required|email|unique:users,email,' . session('created_by_request') . ',code',
            'phone' => 'required|regex:/^([0-9\s\-\+\(\)]*)$/|min:9|unique:users,phone,' . session('created_by_request') . ',code',
