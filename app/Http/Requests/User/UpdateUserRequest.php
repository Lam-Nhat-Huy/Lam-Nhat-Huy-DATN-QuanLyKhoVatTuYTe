...
class UpdateUserRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'email' => 'required|email|unique:users,email,' . session('user_code_request') . ',code',
            'phone' => 'required|regex:/^([0-9\s\-\+\(\)]*)$/|min:9|unique:users,phone,' . session('user_code_request') . ',code',
